export const translations = {
  ...
  ar: {
    ...
    "docs.title": "التوثيق",
    "docs.api.title": "دليل واجهة البرمجة API",
    "docs.api.description": "مرجع المطورين لدمج EduPack",
    "docs.bestPractices.title": "دليل أفضل الممارسات",
    "docs.bestPractices.description": "نصائح عملية لإنشاء دروس SCORM عالية الجودة",
    "docs.scorm.title": "مرجع معايير SCORM",
    "docs.scorm.description": "فهم سريع لمعايير SCORM 1.2 و2004",
    "help.title": "مركز المساعدة",
    "help.description": "دروس تعليمية وأدلة إعداد. (صفحة بداية - سيتم توسيعها لاحقًا)",
    "help.scormBasics": "أساسيات SCORM",
    "help.scormBasicsDesc": "تعلم معايير SCORM 1.2 / 2004 وكيفية عمل التصديرات.",
    ...
    "support.description": "هذه صفحة دعم بداية. لاحقًا يمكنك ربطها بنظام دردشة مباشرة أو تتبع التذاكر.",
    "support.email": "البريد الإلكتروني",
    "support.emailValue": "support@edupack.app",
    "support.liveChat": "دردشة مباشرة",
    "support.liveChatDesc": "دمج أداة الدردشة المباشرة (Crisp / Intercom / Tawk / إلخ).",
    "support.tickets": "التذاكر",
    "support.ticketsDesc": "إضافة نموذج تذكرة أو ربط جدول 'team_messages' (إذا أردت).",
    "resources.reading.title": "موارد أساسية للقراءة",
    "resources.reading.guidance.button": "إرشادات القراءة",
    "resources.help.title": "تحتاج مساعدة؟ تواصل مع فريقنا",
    "resources.help.description": "فريق الدعم جاهز لمساعدتك على النجاح. تواصل معنا في أي وقت بأسئلة أو ملاحظات.",
    "resources.contact.email": "البريد الإلكتروني",
    "resources.contact.liveChat": "دعم الدردشة المباشرة",
    "resources.section.guides": "أدلة حول كيفية البدء",
    "resources.section.resources": "موارد المشروع",
    "resources.section.documentation": "التوثيق",
    "resources.button.readMore": "اقرأ المزيد",
    "essentialResources.title": "موارد أساسية للقراءة",
    "essentialResources.description": "اتبع هذه الموارد لاستكشاف وثائق EduPack ومعايير SCORM وممارسات التنفيذ الموصى بها.",
    ...
    "support.emailValue": "support@edupack.app",
    "support.liveChat": "دردشة مباشرة",
    "support.liveChatDesc": "دمج أداة الدردشة المباشرة هنا (Crisp / Intercom / Tawk / إلخ).",
    "support.tickets": "التذاكر",
    "support.ticketsDesc": "إضافة نموذج تذكرة أو ربط جدول 'team_messages' (إذا أردت).",
