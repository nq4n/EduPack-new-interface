...
This project is a Next.js interface that stores SCORM packages and user data in Supabase and uses the OpenAI API for AI-assisted authoring.
...
- **AI Providers**
  - Set `OPENAI_API_KEY` for AI-assisted authoring. The default model is `gpt-5-mini` (override with `OPENAI_MODEL`).
