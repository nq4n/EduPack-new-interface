...
async function createClient() {
    ...
    ;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createServerClient"])(supabaseUrl, supabaseAnonKey, {
        cookies: {
...
"[project]/lib/profile-data.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "getCurrentUserWithProfileAndPackages",
    ()=>getCurrentUserWithProfileAndPackages
]);
...
;
;
async function getCurrentUserWithProfileAndPackages() {
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
    // 1) auth user
    ...
    // 2) profile row
    const { data: existingProfile, error: profileError } = await supabase.from("profiles").select("*").eq("id", user.id).maybeSingle();
    if (profileError) {
    ...
    if (!profile) {
        ...
        const preferredLanguage = user.user_metadata && user.user_metadata.preferred_language || "en";
    ...
    const { data: packages, error: packagesError } = await supabase.from("packages").select("*").eq("created_by_user_id", user.id).order("created_at", {
        ascending: false
    });
    if (packagesError) {
...
"[project]/app/profile/packages/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$profile$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/profile-data.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function OwnedPackagesPage() {
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$auth$2d$provider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSupabase"])();
    ...
    const loadPackages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        if (!user) {
            setLoading(false);
            return;
        }
        setLoading(true);
        try {
            const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$profile$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUserOwnedPackages"])(user.id);
            if (error) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Error loading packages");
        } finally{
            setLoading(false);
        }
    }, [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__05c0daa2._.js.map