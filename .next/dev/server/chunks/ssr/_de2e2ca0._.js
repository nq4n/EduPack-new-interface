...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        e.preventDefault();
        setError("");
        const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signInWithPassword"])(email, password);
        if (error) {
...
//# sourceMappingURL=_de2e2ca0._.js.map