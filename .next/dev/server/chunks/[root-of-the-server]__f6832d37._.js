...
async function POST(req) {
    try {
        const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createClient"])(); // 👈 IMPORTANT
        ...
        const packageId = typeof project.id === "string" && project.id.trim().length > 0 ? project.id : (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])();
        const safeTitle = project.title?.toString().toLowerCase().replace(/[^a-z0-9]+/gi, "-").replace(/^-+|-+$/g, "") || "package";
        ...
        const { error: storageError } = await supabase.storage.from(bucketName).upload(filePath, fileContent, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f6832d37._.js.map