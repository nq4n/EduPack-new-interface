...
function RegisterPage() {
    ...
    const handleRegister = async (e)=>{
        ...
        const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signUpNewUser"])(email, password, fullName, preferredLanguage);
        if (error) {
...
_s(RegisterPage, "i+8J6Zm7SsuUGL1igPwGZrexbuk=", false, function() {
    return [
...
//# sourceMappingURL=_6e0fd353._.js.map