        ...
        "AuthProvider.useEffect": ()=>{
            const { data: { subscription } } = supabase.auth.onAuthStateChange({
                "AuthProvider.useEffect": async (_, session)=>{
                    ...
                    if (session?.user) {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ensureUserProfile"])(session.user);
                    }
...
//# sourceMappingURL=_a093195b._.js.map