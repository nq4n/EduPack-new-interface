...
function RegisterPage() {
    ...
    const handleRegister = async (e)=>{
        ...
        const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signUpNewUser"])(email, password, fullName);
        if (error) {
...
_s(RegisterPage, "OLlBVDtsxvDF0Bz4jPuCZk0oNuY=", false, function() {
    return [
...
//# sourceMappingURL=_d0b355e1._.js.map