...
"[project]/lib/profile-data.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getCurrentUserWithProfileAndPackages() {
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
    // 1) auth user
...
"[project]/app/profile/packages/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$profile$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/profile-data.ts [app-client] (ecmascript)");
;
...
function OwnedPackagesPage() {
    _s();
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$auth$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSupabase"])();
    ...
    const loadPackages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OwnedPackagesPage.useCallback[loadPackages]": async ()=>{
            if (!user) {
                setLoading(false);
                return;
            }
            setLoading(true);
            try {
                const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$profile$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserOwnedPackages"])(user.id);
                if (error) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Error loading packages");
            } finally{
                setLoading(false);
            }
        }
    }["OwnedPackagesPage.useCallback[loadPackages]"], [
        user
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OwnedPackagesPage.useEffect": ()=>{
            loadPackages();
        }
    }["OwnedPackagesPage.useEffect"], [
        loadPackages
...
_s(OwnedPackagesPage, "OiZabvScafhd0YkFNItzUnn+3X8=", false, function() {
    return [
...
_c = OwnedPackagesPage;
var _c;
__turbopack_context__.k.register(_c, "OwnedPackagesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_fead2621._.js.map