...
function BillingPage() {
    ...
    const loadBillingData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BillingPage.useCallback[loadBillingData]": async ()=>{
            if (!user) {
                setLoading(false);
                return;
            }
            ...
            try {
                const [subResult, creditsResult] = await Promise.all([
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$profile$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserSubscription"])(user.id),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$profile$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserCredits"])(user.id)
                ]);
                setBilling({
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to load billing information");
            } finally{
                setLoading(false);
            }
        }
    }["BillingPage.useCallback[loadBillingData]"], [
        user
    ]);
...
_s(BillingPage, "/4RabaJPdW9a8tUzyc7VN0mPYBY=", false, function() {
    return [
...
//# sourceMappingURL=_e077f4d1._.js.map